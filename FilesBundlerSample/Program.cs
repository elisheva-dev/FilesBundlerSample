...
createRspCommand.SetHandler(() =>
{
    try
    {
        Console.WriteLine("Enter languages (for all languages write 'all')");
        var languages = Console.ReadLine();
        Console.WriteLine("Do you want to save the bundle file in the current folder? (y/n)");
        ...
        Console.WriteLine("Should I list the source code as a comment in the bundle file?(y/n)");
        ...
        Console.WriteLine("Now you can run 'dotnet @Response.rsp' to execute the command.");
    }
    catch (Exception ex)
    {
        Console.WriteLine("ERROR: " + ex.Message);
